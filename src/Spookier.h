...
public:
    ...
    //
    // This is used if the input is 192 bytes long or longer.
    //
...
private:
    ...
    static void ShortInner(
        const uint64 *message,// message (must be aligned if necessary)
        size_t length,        // length of message (in bytes)
        bool abfree,          // true if the a, b value are recently mixed
